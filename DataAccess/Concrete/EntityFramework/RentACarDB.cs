    ...
    public class RentACarDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Rental>().HasData(
                new Rental { Id = 1, CarId = 1, CustomerId = 1, RentDate = new DateTime(2024, 04, 20), ReturnDate = new DateTime(2024, 04, 25), IsActive = true, IsDeleted = false },
                new Rental { Id = 2, CarId = 3, CustomerId = 2, RentDate = new DateTime(2024, 04, 20), ReturnDate = new DateTime(2024, 04, 25), IsActive = true, IsDeleted = false },
                new Rental { Id = 3, CarId = 2, CustomerId = 3, RentDate = new DateTime(2024, 04, 20), ReturnDate = new DateTime(2024, 04, 25), IsActive = true, IsDeleted = false }
                );
